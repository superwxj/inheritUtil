...
public class HelloOss {
    ...
    private static String accessKeyId = "LTAIuwoDJYPSQCz0";
    private static String accessKeySecret = "6pQQVlVye3GlZi3Bxtn8Etz6l1H17A";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "superjian";

    // Object是OSS存储数据的基本单元，称为OSS的对象，也被称为OSS的文件。详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Object命名规范如下：使用UTF-8编码，长度必须在1-1023字节之间，不能以“/”或者“\”字符开头。
    private static String firstKey = "HeadPortrait/";
...
//        PropertyConfigurator.configure("conf/log4j.properties");
        ...
        try {
            ...
            ossClient.putObject(bucketName, firstKey + "hello.txt", is);
            ...
            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
            String fileKey = "1.txt";
            ossClient.putObject(bucketName, firstKey + fileKey, new File("/Users/jwang/wangjCode/IdeaProjects/inheritUtil/aliyun-oss/src/1.txt"));
            ...
            System.out.println("删除Object：" + firstKey + fileKey + "成功。");
